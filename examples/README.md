...
| `langgraph_memory.py` | `mnemosyne-langgraph` | Mnemosyne as a LangGraph `BaseStore`: memory across runs, a hypothesis `branch`, `why` |
| `mcp_client.py` | `mnemosyne-agents-mcp` | drive the MCP server over stdio the way an MCP client would |
