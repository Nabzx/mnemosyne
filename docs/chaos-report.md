...
The harness is `crates/mnem-core/tests/merge_chaos.rs`. It is seeded (a
...
MNEM_CHAOS_ALGEBRA_TRIALS=50000 MNEM_CHAOS_STORE_TRIALS=250 \
  cargo test -p mnem-core --test merge_chaos --release
...
```
MNEM_CHAOS_ALGEBRA_TRIALS=<N+1> cargo test -p mnem-core --test merge_chaos -- merge_state_maps_algebra
```
