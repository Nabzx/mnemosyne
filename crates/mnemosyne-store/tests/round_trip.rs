...
//! byte-identical. Black box: only the public `mnemosyne-store` API, plus a raw read
//! of the object table to compare bytes.

use std::collections::BTreeMap;

use mnemosyne_store::codec;
use mnemosyne_store::objects::{self, OBJECTS};
use mnemosyne_store::{ContentKind, MemoryNode, Object, ObjectId, Provenance, Store};
