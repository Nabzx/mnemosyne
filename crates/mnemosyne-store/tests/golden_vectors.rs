...
//!
//! Run `cargo test -p mnemosyne-store --test golden_vectors -- --nocapture --ignored print`
//! to print the current vectors when adding a case.

use mnemosyne_store::codec;
use mnemosyne_store::{Commit, ContentKind, MemoryNode, Object, ObjectId, Provenance, State};
use serde_json::json;
