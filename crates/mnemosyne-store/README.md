...
The `mnem` command-line tool is the [`mnemosyne-git`](https://crates.io/crates/mnemosyne-git)
crate. The Python SDK is `mnemosyne-agents` on PyPI.

```rust
use mnemosyne_store::Store;
