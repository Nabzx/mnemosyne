...
//! byte-identical. Black box: only the public `mnem-store` API, plus a raw read
//! of the object table to compare bytes.

use std::collections::BTreeMap;

use mnem_store::codec;
use mnem_store::objects::{self, OBJECTS};
use mnem_store::{ContentKind, MemoryNode, Object, ObjectId, Provenance, Store};
